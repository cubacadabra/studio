...
#[derive(Debug)]
struct ManifestSceneMigration {
    scene: AuthoringScene,
    cleaned_manifest: Value,
    target_map: BTreeMap<String, String>,
}

fn migrate_manifest_to_scene(source: &str) -> Result<ManifestSceneMigration, String> {
...
fn retarget_migrated_scene_edit(
